...
//***************************************************************************************************
console.log("[Info] - AISC for TESTNET - ver. 1.00 - Starting");
...
async function mainloop(){
    ...
    app.post('/mint',async function(req, res) {
        ...
        console.log("[Info] Transferring 10 AISC for ",account);
        
        // generate key pair from Seed
        const keyring = new Keyring({ type: 'sr25519', ss58Format: 42 });
        const keyspair = keyring.createFromUri(SECRETSEED, { name: 'sr25519' });
        const wsProvider = new WsProvider('wss://testnet.aisland.io');  
        ...
        console.log("[INFO] Connected to Aisland Node with genesis: ",api.genesisHash.toHex())
        //make transfer
            api.tx.balances
...
const options = {
    key: fs.readFileSync("/etc/letsencrypt/live/testnet.aisland.io/privkey.pem"),
    cert: fs.readFileSync("/etc/letsencrypt/live/testnet.aisland.io/fullchain.pem")
};
