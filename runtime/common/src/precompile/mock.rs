...
pub const AISC: CurrencyId = CurrencyId::Token(TokenSymbol::AISC);
pub const AISD: CurrencyId = CurrencyId::Token(TokenSymbol::AISD);

parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = AISC;
}
...
parameter_types! {
	...
	pub AllNonNativeCurrencyIds: Vec<CurrencyId> = vec![CurrencyId::Token(TokenSymbol::AISD)];
}
...
pub const AISC_ERC20_ADDRESS: &str = "0x0000000000000000000000000000000001000000";
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	ext.execute_with(|| {
		...
		assert_ok!(Currencies::update_balance(Origin::root(), ALICE, AISD, 1_000_000_000));
