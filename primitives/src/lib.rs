...
pub mod currency {
    ...
    pub const AISC: Balance = DOLLARS;
    pub const MILLI_AISC: Balance = AISC / 1_000;
    pub const MICRO_AISC: Balance = AISC / 1_000_000;
}
...
impl TryFrom<u8> for TokenSymbol {
    ...
    fn try_from(v: u8) -> Result<Self, Self::Error> {
        match v {
            0 => Ok(TokenSymbol::AISC),
            1 => Ok(TokenSymbol::AISD),
            _ => Err(()),
        }
    }
}
